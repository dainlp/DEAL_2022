...
def pad_and_concatenate(tensor1, tensor2, padding_index=-100):
    ...
    concat = tensor1.new_full(new_shape, padding_index)
    concat[:tensor1.shape[0], : tensor1.shape[1]] = tensor1
    concat[tensor1.shape[0]:, : tensor2.shape[1]] = tensor2
    return concat


'''[Apr-01-2022] https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/trainer_pt_utils.py#L97'''
...
'''[Apr-01-2022] https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/trainer_pt_utils.py#L135'''
...
'''[Apr-01-2022] https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/trainer_utils.py#L502'''
