import dataclasses, logging, time, torch, transformers
import os
...
'''[20220512] https://github.com/huggingface/transformers/blob/v4.16.2/src/transformers/training_args.py#L1321'''
...
@dataclass
class ArgumentsBase:
    task_name: str = field(default="singlelabel")
...
class TrainingArguments:
    ...
    task_learning_rate: float = field(default=None) # set a larger lr for heads and smaller lr for pre-trained encoders
...
'''[20220522]'''
@dataclass
class ArgumentsForSpanNER(Arguments):
    max_span_length: int = field(default=8)
