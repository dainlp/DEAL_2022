...
class MultiHeadSelfAttention(torch.nn.Module):
    def __init__(self, hidden_size, num_heads, dropout, output_dim=None):
    ...
    def forward(self, hidden_states, attention_mask):
        ...
        attention_scores = attention_scores + attention_mask # value in attention_mask will be 0 or -10000.0
